...
#get the source to base PAR 1.4.6
curl -L -O http://apache.mirror1.spango.com/apr/apr-1.5.1.tar.gz
...
curl -L -O http://apache.mirror1.spango.com//apr/apr-util-1.5.4.tar.gz
